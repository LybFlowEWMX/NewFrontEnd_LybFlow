...
export default {
  data() {
    return {
      ...
      minimo: "",
      minimoInicio: "",
      visible: false, //pasar a false para que se contraiga
      checked: false,
      link: "",
      //value2: [{ name: "Javascript", code: "js" }],
      optionsTagIngreso: [],
      options: [
        { item: "Diario", name: "Diario" },
        { item: "Semanal", name: "Semanal" },
        { item: "Mensual", name: "Mensual" },
        { item: "Dias del mes", name: "Días del mes" },
