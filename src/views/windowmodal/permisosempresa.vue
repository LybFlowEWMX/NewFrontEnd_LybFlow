          ...
          <CCol>
            <CCard>
              <CCardHeader class="bg-primary">
                <h2 class="text-center text-white">  <b-icon icon="gear" ></b-icon>Permisos para Empresas</h2>
              </CCardHeader>
              <CCardBody>
...
export default {
 ...
 selected: [], // Must be an array reference!
        permisosoptions: [
          { text: 'Mostrar Empresa', value: 1 },

          { text: 'Editar Empresa', value: 2 },
          { text: 'Eliminar Empresa', value: 3 },
        ],
...
formulario.empresa_id=this.form.id;
      ...
      try {
        await repo.compartepersmisoempresa(formulario).then((res) => {
